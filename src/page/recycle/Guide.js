                ...
                onClick={() => {
                  navigate("/detail", {
                    state: [
                      ...
                      "주의사항)\n투명 페트병은 다른 일반 페트병과 분리하여 배출하면 좋다.\n세로로 너무 납작하게 부피를 줄일 경우, 자동화 분류 과정에서 분류가 안 될 수 있으니 주의하자",
                    ],
                  });
                }}
              >
                ...
                onClick={() => {
                  navigate("/detail", {
                    state: [
                      ...
                      "",
                      "",
                      "주의사항\n작은 인형의 경우, 종량제 봉투에 담아 버리고, 대형 인형은 폐기물 스티커를 부착하여 배출한다.",
                    ],
                  });
                }}
              >
                ...
                onClick={() => {
                  navigate("/detail", {
                    state: [
                      ...
                      "",
                      "",
                      "주의사항\n카드 정보 등의 개인정보가 노출될 수 있으므로 적당히 찢어서 버린다.",
                    ],
                  });
                }}
              >
